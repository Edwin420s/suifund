...
export const NETWORK = V.VITE_SUI_NETWORK || 'devnet'

export const CONTRACT_ADDRESSES = {
  devnet: {
    CAMPAIGN_PACKAGE: V.VITE_CAMPAIGN_PACKAGE_DEVNET || '',
    PREDICTION_MARKET_PACKAGE: V.VITE_PREDICTION_MARKET_PACKAGE_DEVNET || '',
    NFT_PACKAGE: V.VITE_NFT_PACKAGE_DEVNET || '',
    TREASURY_PACKAGE: V.VITE_TREASURY_PACKAGE_DEVNET || '',
    UTILS_PACKAGE: V.VITE_UTILS_PACKAGE_DEVNET || ''
  },
  testnet: {
    CAMPAIGN_PACKAGE: V.VITE_CAMPAIGN_PACKAGE_TESTNET || '',
    PREDICTION_MARKET_PACKAGE: V.VITE_PREDICTION_MARKET_PACKAGE_TESTNET || '',
    NFT_PACKAGE: V.VITE_NFT_PACKAGE_TESTNET || '',
    TREASURY_PACKAGE: V.VITE_TREASURY_PACKAGE_TESTNET || '',
    UTILS_PACKAGE: V.VITE_UTILS_PACKAGE_TESTNET || ''
  },
  mainnet: {
    CAMPAIGN_PACKAGE: V.VITE_CAMPAIGN_PACKAGE_MAINNET || '',
    PREDICTION_MARKET_PACKAGE: V.VITE_PREDICTION_MARKET_PACKAGE_MAINNET || '',
    NFT_PACKAGE: V.VITE_NFT_PACKAGE_MAINNET || '',
    TREASURY_PACKAGE: V.VITE_TREASURY_PACKAGE_MAINNET || '',
    UTILS_PACKAGE: V.VITE_UTILS_PACKAGE_MAINNET || ''
  }
}

// Derived commonly-used values
export const CURRENT_ADDRESSES = CONTRACT_ADDRESSES[NETWORK] || CONTRACT_ADDRESSES.devnet
export const PACKAGE_ID = CURRENT_ADDRESSES.CAMPAIGN_PACKAGE
export const CAMPAIGN_MODULE = 'campaign'
export const CHAIN = NETWORK === 'mainnet' ? 'sui:mainnet' : NETWORK === 'testnet' ? 'sui:testnet' : 'sui:devnet'
...
export const API_ENDPOINTS = {
  GRAPHQL: V.VITE_GRAPHQL_ENDPOINT || '',
  REST: V.VITE_REST_API_ENDPOINT || '',
  WS: V.VITE_WS_ENDPOINT || ''
}
...
export const FEATURES = {
  PREDICTION_MARKETS: V.VITE_ENABLE_PREDICTION_MARKETS === 'true',
  GOVERNANCE: V.VITE_ENABLE_GOVERNANCE === 'true',
  NFT_REWARDS: V.VITE_ENABLE_NFT_REWARDS === 'true',
  SOCIAL_FEATURES: V.VITE_ENABLE_SOCIAL_FEATURES === 'true',
  ANALYTICS: V.VITE_ENABLE_ANALYTICS === 'true'
}
